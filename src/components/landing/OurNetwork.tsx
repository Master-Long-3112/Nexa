  ...
  return (
    <div className="@container flex items-center justify-center">
      <div>
        ...
        <p className="w-150">
          NEXA Network không chỉ là một Agency, chúng tôi là "kiến trúc sư" xây
          dựng cộng đồng và giá trị thương hiệu. Với mạng lưới kết nối sâu rộng
          trên các nền tảng TikTok, Facebook, Instagram và YouTube, chúng tôi
          hiểu cách để biến một nội dung trở thành xu hướng và biến một thương
          hiệu trở thành biểu tượng.
        </p>
      </div>

      <div className="relative h-120 aspect-square ms-10 mt-10">
        {/* SVG nền */}
        <svg
          viewBox="0 0 504 504"
          xmlns="http://www.w3.org/2000/svg"
        ...
        >
          ...
          <defs>
            ...
            >
              ...
              <stop offset="1" stop-color="#8FF2F4" />
            </linearGradient>
          </defs>
        </svg>
